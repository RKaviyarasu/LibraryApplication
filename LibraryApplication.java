...
public class LibraryApplication {
	...
	public void getMenu() throws Exception {
		...
		do {
			...
			System.out.println("Press 1 to continue otherwise you are Exit from Main Menu");
	...
	public void owner() throws Exception {
		...
		do {
			...
			System.out.println("Press 1 to Continue with owner Process Otherwise you Exit from Owner process \nEnter your Choice: ");
			exitChoice = gettingInput.getExitChoice();
		}while(exitChoice.equals("1"));
	...
	public void customer() throws Exception {
		...
		if(customerProcess.isUser(userName)) {
			...
			do {
				...
				System.out.println("Press 1 to Continue otherwise you are Exit");
